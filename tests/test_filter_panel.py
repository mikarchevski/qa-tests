...
class TestFilterPanel:
    ...
    def test_new_file(self, authenticated_page, temp_file, cleanup_uploaded_files):
    ...
    # def test_new_img(self, authenticated_page, temp_img, cleanup_uploaded_files):
    ...
    # def test_filter_video(self, authenticated_page, temp_video, cleanup_uploaded_files):
